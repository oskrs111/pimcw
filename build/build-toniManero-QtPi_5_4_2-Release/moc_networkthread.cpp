...
#include "../../toniManero/networkthread.h"
...
QT_MOC_LITERAL(1, 14, 10), // "midiUpdate"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 11), // "midiMessage"
QT_MOC_LITERAL(4, 38, 7), // "message"
QT_MOC_LITERAL(5, 46, 11) // "OnReadyRead"

    },
    "networkThread\0midiUpdate\0\0midiMessage\0"
    "message\0OnReadyRead"
};
...
void networkThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->midiUpdate((*reinterpret_cast< midiMessage(*)>(_a[1]))); break;
        ...
        {
            typedef void (networkThread::*_t)(midiMessage );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&networkThread::midiUpdate)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void networkThread::midiUpdate(midiMessage _t1)
{
